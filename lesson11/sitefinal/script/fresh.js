  ...
  function populateDropdownList() {
    var select1 = document.getElementById("fruitSelect1");
    var select2 = document.getElementById("fruitSelect2");
    var select3 = document.getElementById("fruitSelect3");

    fruits.forEach(function(fruit) {
      var option1 = document.createElement("option");
      option1.text = fruit.name;
      option1.value = JSON.stringify(fruit);
      select1.add(option1);

      var option2 = document.createElement("option");
      option2.text = fruit.name;
      option2.value = JSON.stringify(fruit);
      select2.add(option2);

      var option3 = document.createElement("option");
      option3.text = fruit.name;
      option3.value = JSON.stringify(fruit);
      select3.add(option3);
    });
  }

  // Function to display selected fruits' nutritional information
  function displayNutritionalInfo() {
    var select1 = document.getElementById("fruitSelect1");
    var select2 = document.getElementById("fruitSelect2");
    var select3 = document.getElementById("fruitSelect3");
    ...
    var selectedFruits = [select1.value, select2.value, select3.value];
    selectedFruits.forEach(function(selectedFruit) {
      if (selectedFruit !== "") {
        var fruit = JSON.parse(selectedFruit);
        ...
        list.appendChild(sugar);

        card.appendChild(list);
        nutritionalInfo.appendChild(card);
      }
    });
  }

  // Populate dropdown list on page load
  populateDropdownList();

  // Add event listeners to dropdown lists
  var selects = document.querySelectorAll("select");
  selects.forEach(function(select) {
    select.addEventListener("change", displayNutritionalInfo);
  });
